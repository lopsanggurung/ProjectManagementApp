...
export interface IAdminClient {
    ...
    editRoles(userName: string | null, roleEditDto: RoleEditDto): Observable<FileResponse>;
    getUsersForManager(): Observable<FileResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class AdminClient extends ApiClientBase implements IAdminClient {
    ...
    getUsersWithRoles(): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Admin/usersWithRoles";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUsersWithRoles(<any>response_);
                } catch (e) {
    ...
    editRoles(userName: string | null, roleEditDto: RoleEditDto): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Admin/editRoles/{userName}";
        if (userName === undefined || userName === null)
            throw new Error("The parameter 'userName' must be defined.");
        url_ = url_.replace("{userName}", encodeURIComponent("" + userName));
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(roleEditDto);
    ...
    getUsersForManager(): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Admin/usersForManager";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUsersForManager(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUsersForManager(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUsersForManager(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface IAuthClient {
    register(userForRegisterDto: UserForRegisterDto): Observable<FileResponse>;
    login(userForLoginDto: UserForLoginDto): Observable<FileResponse>;
}
...
export class TodoItemsClient extends ApiClientBase implements ITodoItemsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class TodoListsClient extends ApiClientBase implements ITodoListsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export interface IUsersClient {
    getUser(id: string | null): Observable<FileResponse>;
    updateUser(id: string | null, userForUpdateDto: UserForUpdateDto): Observable<FileResponse>;
    getUsers(): Observable<FileResponse>;
    createUser(userForCreateDto: UserForCreateDto): Observable<FileResponse>;
}
...
export class UsersClient extends ApiClientBase implements IUsersClient {
    ...
    updateUser(id: string | null, userForUpdateDto: UserForUpdateDto): Observable<FileResponse> {
        ...
        const content_ = JSON.stringify(userForUpdateDto);
    ...
    createUser(userForCreateDto: UserForCreateDto): Observable<FileResponse> {
        ...
        const content_ = JSON.stringify(userForCreateDto);
...
export class ValuesClient extends ApiClientBase implements IValuesClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class UserForCreateDto implements IUserForCreateDto {
    userName!: string;
    password!: string;
    created?: Date;
    lastActive?: Date;

    constructor(data?: IUserForCreateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserForCreateDto {
        data = typeof data === 'object' ? data : {};
        let result = new UserForCreateDto();
        result.init(data);
        return result;
    }
...
export interface IUserForCreateDto {
    userName: string;
    password: string;
    created?: Date;
    lastActive?: Date;
...
export class UserForUpdateDto implements IUserForUpdateDto {
    ...
    constructor(data?: IUserForUpdateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserForUpdateDto {
        data = typeof data === 'object' ? data : {};
        let result = new UserForUpdateDto();
        result.init(data);
        return result;
    }
